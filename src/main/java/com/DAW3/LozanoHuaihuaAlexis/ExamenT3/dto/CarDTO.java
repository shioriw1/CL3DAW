package com.DAW3.LozanoHuaihuaAlexis.ExamenT3.dto;
...
public class CarDTO {
    ...
    public CarDTO(Integer carId, String make, String model, int year, String vin, String licensePlate, String ownerName, String ownerContact, LocalDate purchaseDate, int mileage, String engineType, String color, String insuranceCompany, String insurancePolicyNumber, LocalDate registrationExpirationDate, LocalDate serviceDueDate) {
        this.carId = carId;
        this.make = make;
        this.model = model;
        this.year = year;
